...
public class RecursiveDescent {
	...
	public NFA_Identifier descend() {
		...
		System.out.println("[RDescent] starting...");
		
		stack.push(new NFA());
		regEx();
		NFA new_nfa = stack.pop();
		
		System.out.println("[RDescent] finalizing...");
	...
	private ArrayList<Character> charSetTail(Token start, ArrayList<Character> range){
		...
		if(type == TokenType.DASH){
			...
			while(current_index <= end_index) {
				System.out.println("[RDescent][CharSet] adding \'" + ((char)current_index + 32) + "\' to range...");
	...
	private ArrayList<Character> definedClass(Token token, boolean exclude){
		...
		if(index == -1) {
			//TODO error handling
			System.out.println("[RDescent] char class: \"" + token.getType() + "\" does not exist");
		}
